...
public abstract class AuditEntity extends IdEntity {
    ...
    @CreatedDate
    @Column(name = "created_date", nullable = false,columnDefinition = "number(19,0)")
    ...
    @LastModifiedDate
    @Column(name = "last_modified_date",columnDefinition = "number(19,0)")
    @Type(type="com.troy.keeper.core.base.entity.InstantLong")
    @Audited
    private Instant lastUpdatedDate = Instant.now();
    @Column(name = "data_status",columnDefinition = "number(1,0)")
