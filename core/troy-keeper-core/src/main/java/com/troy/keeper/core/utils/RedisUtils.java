...
public class RedisUtils {
     ...
     * 返回包含要翻译的字段值的T
     * @param t
     * @param listKeys             获取List的key列表,
     * @param sourceColumns      源column列表,顺序必须和listKeys的顺序一致
     * @param distColumns        目标columns列表，顺序必须和listKeys的顺序一致
     * @param <T>
     * @return
     * @throws Exception
     */
     ...
     * @param t
     * @param sourceColumns      源column列表
     * @param distColumns        目标columns列表，顺序必须和sourceColumns的顺序一致
     * @param <T>
     * @return
     * @throws Exception
     */
