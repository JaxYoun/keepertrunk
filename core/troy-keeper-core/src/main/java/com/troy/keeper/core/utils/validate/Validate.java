package com.troy.keeper.core.utils.validate;

import com.troy.keeper.core.error.KeeperException;
import com.troy.keeper.core.utils.exception.ExceptionUtils;
...
public class Validate {
    ...
    public static void isTrue(final boolean expression, final String message, final long value) {
        if (expression == false) {
            throw ExceptionUtils.getValidateException(String.format(message, Long.valueOf(value)));
        }
    }
    ...
    public static void isTrue(final boolean expression, final String message, final double value) {
        if (expression == false) {
            throw ExceptionUtils.getValidateException(String.format(message, Double.valueOf(value)));
        }
    }
    ...
    public static void isTrue(final boolean expression, final String message, final Object... values) {
        if (expression == false) {
            throw ExceptionUtils.getValidateException(String.format(message, values));
        }
    }
    ...
    public static void isTrue(final boolean expression) {
        if (expression == false) {
            throw ExceptionUtils.getValidateException(DEFAULT_IS_TRUE_EX_MESSAGE);
        }
    }
    ...
    public static <T> T[] noNullElements(final T[] array, final String message, final Object... values) {
        ...
        for (int i = 0; i < array.length; i++) {
            if (array[i] == null) {
                ...
                throw ExceptionUtils.getValidateException(String.format(message, values2));
            }
        }
        return array;
    }
    ...
    public static void validState(final boolean expression) {
        if (expression == false) {
            throw ExceptionUtils.getValidateException(DEFAULT_VALID_STATE_EX_MESSAGE);
        }
    }
    ...
    public static void matchesPattern(final CharSequence input, final String pattern) {
        ...
        if (Pattern.matches(pattern, input) == false) {
            throw ExceptionUtils.getValidateException(String.format(DEFAULT_MATCHES_PATTERN_EX, input, pattern));
        }
    }
    ...
    public static <T> void inclusiveBetween(final T start, final T end, final Comparable<T> value) {
        ...
        if (value.compareTo(start) < 0 || value.compareTo(end) > 0) {
            throw ExceptionUtils.getValidateException(String.format(DEFAULT_INCLUSIVE_BETWEEN_EX_MESSAGE, value, start, end));
        }
    }
    ...
    public static void inclusiveBetween(final long start, final long end, final long value, final String message) {
        // TODO when breaking BC, consider returning value
        if (value < start || value > end) {
            throw ExceptionUtils.getValidateException(String.format(message));
        }
    }
    ...
    public static <T> void exclusiveBetween(final T start, final T end, final Comparable<T> value) {
        // TODO when breaking BC, consider returning value
        if (value.compareTo(start) <= 0 || value.compareTo(end) >= 0) {
            throw ExceptionUtils.getValidateException(String.format(DEFAULT_EXCLUSIVE_BETWEEN_EX_MESSAGE, value, start, end));
        }
    }
    ...
    public static void isInstanceOf(final Class<?> type, final Object obj) {
        ...
        if (type.isInstance(obj) == false) {
            throw ExceptionUtils.getValidateException(String.format(DEFAULT_IS_INSTANCE_OF_EX_MESSAGE, type.getName(),
