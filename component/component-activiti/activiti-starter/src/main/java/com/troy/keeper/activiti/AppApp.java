package com.troy.keeper.activiti;


import com.troy.keeper.activiti.config.ApplicationProperties;
...
public class AppApp {
    ...
    public static void main(String[] args) throws UnknownHostException {
        ...
        String message = (configServerStatus == null ? "Not found or not setup for this application" : configServerStatus);
        log.info("\n----------------------------------------------------------\n\t" +
                        "Config Server: \t{}\n----------------------------------------------------------",
                message);
    }
