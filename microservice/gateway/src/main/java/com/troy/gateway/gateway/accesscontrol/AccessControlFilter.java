package com.troy.gateway.gateway.accesscontrol;
...
public class AccessControlFilter extends ZuulFilter {
    ...
    public boolean shouldFilter() {
        ...
        for (Route route : routeLocator.getRoutes()) {
            ...
            if (requestUri.startsWith(serviceUrl.substring(0, serviceUrl.length() - 2)) || requestUri.startsWith(serviceName,1) ) {
                boolean isAuthorizedRequest = !isAuthorizedRequest(serviceUrl, serviceName, requestUri);
                log.debug("serviceUrl:{}, serviceName:{}, filter:{}", serviceUrl, serviceName, isAuthorizedRequest);
